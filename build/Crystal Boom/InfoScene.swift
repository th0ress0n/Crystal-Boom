...
class InfoScene: SKScene {
    ...
    func addGraphics(){
        ...
        modalBGimg = SKSpriteNode(texture: modalBGLg)
        modalCloseimg = SKSpriteNode(texture: modalCloseBtn)
        
        
        
        let modalBgWidth = screenSize.width*0.9
        ...
        modalCloseimg.position = CGPoint(x:self.frame.midX * 1.7, y:self.frame.midY * 1.8);
